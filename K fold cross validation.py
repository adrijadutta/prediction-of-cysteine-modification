...
for train, test in kfold.split(X_train, y_train):
  ...
  history = model.fit(X_train[train], y_train[train], batch_size = 256, epochs = 50, validation_data = (X_train[test], y_train[test]), shuffle = False, callbacks = callbacks_list, class_weight = weights)

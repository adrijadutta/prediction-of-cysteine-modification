...
ds = pd.read_csv('/home/admin123/Desktop/NN/deepcys100.csv')
...
for i in range(len(pdb)):
	...
	list_ind = 0
	file1 = '/home/admin123/Desktop/NN/pdb/' + pdb_id.upper() +'.pdb'
	file2 = '/home/admin123/Desktop/NN/pdb/' + pdb_id.lower() +'.pdb'
